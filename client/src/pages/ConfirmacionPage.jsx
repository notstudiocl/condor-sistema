...
export default function ConfirmacionPage({ orden, onNuevaOrden }) {
  ...
  return (
    <div className="min-h-[calc(100vh-56px)] bg-gradient-to-br from-condor-900 via-condor-800 to-condor-700 p-4 pb-8">
      <div className="max-w-md mx-auto pt-8">
        ...
        {/* Resumen */}
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-5 space-y-3 text-white">
          ...
          {trabajosActivos.length > 0 && (
            <div className="border-t border-white/10 pt-3">
              ...
              {trabajosActivos.map((t) => (
                ...
                >
                  <span className="text-white/80">{t.nombre}</span>
                  <span className="font-semibold">x{t.cantidad}</span>
                </div>
              ))}
            </div>
          )}
